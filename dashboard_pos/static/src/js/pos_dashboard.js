...
var PosDashboard = AbstractAction.extend({
    ...
    fetch_data: function() {
        ...
        var def1 =  this._rpc({
           ...
           self.amount_today = result['amount_today']
           self.total_moy = result['total_moy']
           self.total_qty_sell_day = result['total_qty_sell_day']
           self.qty_my_client = result['qty_my_client']
           self.price_my_product = result['price_my_product']
        });
      var def2 = self._rpc({
            model: "pos.order",
            method: "get_details",
